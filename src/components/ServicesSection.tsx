    ...
    <section className="bg-gray-50 py-4 md:py-8 border-b border-gray-100">
      <div className="container mx-auto max-w-[1400px] px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 lg:gap-8">
          ...
          {/* Service 1 - About Us */}
          <Link to="/about" className="col-span-2 lg:col-span-2 bg-gradient-to-br from-pink-50 to-white border border-pink-200 rounded-xl md:rounded-2xl p-5 md:p-8 flex flex-col sm:flex-row lg:flex-row items-center sm:items-start lg:items-center xl:items-start group cursor-pointer hover:shadow-xl hover:border-pink-400 transition-all">
            <div className="bg-pink-100 p-3 md:p-4 rounded-full text-pink-600 mb-4 sm:mb-0 sm:mr-6 lg:mb-4 lg:mr-0 xl:mb-0 xl:mr-6 group-hover:scale-110 group-hover:bg-green-50 transition-transform">
              <User className="w-6 h-6 md:w-8 md:h-8 group-hover:text-green-600" />
            </div>
            <div className="flex-1 flex flex-col h-full justify-between">
              <div>
                <h3 className="text-base md:text-xl font-extrabold text-gray-900 mb-2 group-hover:text-pink-600 leading-tight">About The Clinic</h3>
              ...
              <span className="text-green-600 font-bold text-xs md:text-sm uppercase tracking-wider flex items-center group-hover:underline mt-auto">
          ...
          {/* Service 2 - Clinic */}
          <Link to="/book-appointment" className="col-span-1 bg-gradient-to-br from-green-50 to-white border border-green-200 rounded-xl md:rounded-2xl p-4 md:p-8 flex flex-col sm:flex-row lg:flex-col xl:flex-row items-start group cursor-pointer hover:shadow-xl hover:border-green-400 transition-all">
            <div className="hidden sm:block bg-green-100 p-3 md:p-4 rounded-full text-green-700 mb-4 sm:mb-0 sm:mr-6 lg:mb-4 lg:mr-0 xl:mb-0 xl:mr-6 group-hover:scale-110 group-hover:bg-pink-50 transition-transform">
              <Calendar className="w-6 h-6 md:w-8 md:h-8 group-hover:text-pink-500" />
            </div>
            <div className="flex-1 flex flex-col h-full">
              <div className="sm:hidden bg-green-100 p-2.5 rounded-full text-green-700 mb-3 w-max self-start group-hover:scale-110 transition-transform">
                <Calendar className="w-5 h-5 group-hover:text-pink-500" />
              </div>
              <h3 className="text-sm md:text-xl font-extrabold text-gray-900 mb-1.5 md:mb-2 group-hover:text-green-700 leading-tight">Book Clinic Appointment</h3>
              ...
              <span className="text-pink-500 font-bold text-[10px] md:text-sm uppercase tracking-wider flex items-center group-hover:underline mt-auto">
